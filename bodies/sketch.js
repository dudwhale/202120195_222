...
function setup() {
  ...
  // setup ground
  groundLeft = new Block(
    world,
    { x: 184, y: 600, w: 500, h: 30, color: "pink" },
    {
      isStatic: true,
      angle: PI * 0.15,
    }
  );
  groundRight = new Block(
    world,
    { x: 615, y: 600, w: 500, h: 30, color: "pink" },
    {
      isStatic: true,
      angle: PI * -0.15,
    }
  ...
  mouse = new Mouse(engine, canvas, { stroke: "pink", strokeWeight: 2 });
